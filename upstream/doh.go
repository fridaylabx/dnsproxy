...
const (
	...
	// implementation, see https://github.com/fridaylabx/dnsproxy/issues/278.
...
func (p *dnsOverHTTPS) exchangeHTTPSClient(
	...
	// https://github.com/fridaylabx/dnsproxy/issues/211.
...
func (p *dnsOverHTTPS) createTransport() (t http.RoundTripper, err error) {
	...
	//
	// See https://github.com/fridaylabx/dnsproxy/issues/11.
